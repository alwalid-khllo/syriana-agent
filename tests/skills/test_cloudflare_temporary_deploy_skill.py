...
class TestRealWorldOutput:
    ...
    REAL = (
        ...
        "Uploaded syriana-temp-hello (0.74 sec)\n"
        "Deployed syriana-temp-hello triggers (0.42 sec)\n"
        "  https://syriana-temp-hello.serene-temple.workers.dev\n"
    )
    ...
    def test_all_fields_from_real_output(self):
        r = pdo.parse(self.REAL)
        assert r["live_url"] == "https://syriana-temp-hello.serene-temple.workers.dev"
