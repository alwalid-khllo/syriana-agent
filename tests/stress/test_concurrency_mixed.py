...
def worker_loop(worker_id: int, syriana_home: str, result_file: str) -> None:
...
def reclaimer_loop(syriana_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="syriana_mixed_stress_")
    print(f"SYRIANA_HOME = {home}")
