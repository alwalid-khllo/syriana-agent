...
The unit tests in tests/syriana_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned syriana-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/syriana")
from syriana_cli.service_manager import S6ServiceManager
