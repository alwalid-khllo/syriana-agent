...
def store(tmp_path, monkeypatch):
    ...
    ~/.syriana/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at syriana_state import time, before pytest's SYRIANA_HOME monkeypatch
    fires — the autouse fixture's SYRIANA_HOME override doesn't help here.)
    """
