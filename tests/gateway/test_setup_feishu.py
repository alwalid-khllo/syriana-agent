"""Tests for _setup_feishu() in syriana_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("syriana_cli.config.save_env_value", side_effect=mock_save), \
         patch("syriana_cli.config.get_env_value", side_effect=mock_get), \
         patch("syriana_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("syriana_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("syriana_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("syriana_cli.cli_output.print_header"), \
         patch("syriana_cli.cli_output.print_info"), \
         patch("syriana_cli.cli_output.print_success"), \
         patch("syriana_cli.cli_output.print_warning"), \
         patch("syriana_cli.cli_output.print_error"), \
