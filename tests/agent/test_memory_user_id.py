...
class TestMem0UserIdScoping:
    ...
    def test_no_user_id_no_config_uses_syriana_user(self):
        """Without user_id or config override, should default to 'syriana-user'."""
        from plugins.memory.mem0 import Mem0MemoryProvider
        ...
        assert provider._user_id == "syriana-user"
...
class TestAIAgentUserIdPropagation:
    ...
    def test_user_id_stored_on_agent(self):
        ...
        with patch.dict(os.environ, {"SYRIANA_HOME": "/tmp/test_syriana"}):
