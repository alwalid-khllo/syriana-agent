...
thinking phase.  Syriana's default cloud-stream stale detector
(``SYRIANA_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``SYRIANA_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
