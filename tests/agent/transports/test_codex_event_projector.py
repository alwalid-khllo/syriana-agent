"""Tests for CodexEventProjector — codex item/* events → Syriana messages list.
...
class TestRoleAlternationInvariant:
    ...
    one item — that breaks Syriana' message alternation invariant."""
