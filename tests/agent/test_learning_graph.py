...
def test_syriana_meta_tolerates_non_dict():
    assert learning_graph._syriana_meta({"metadata": "junk"}) == {}
    assert learning_graph._syriana_meta({"metadata": {"syriana": "junk"}}) == {}
    assert learning_graph._syriana_meta({"metadata": {"syriana": {"category": "x"}}}) == {"category": "x"}
