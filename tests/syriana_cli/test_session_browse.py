"""Tests for the interactive session browser (`syriana sessions browse`).
...
from syriana_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """syriana sessions browse should be parseable."""
