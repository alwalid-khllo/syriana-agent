...
The main() function in syriana_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `syriana -c model`
...
def _build_parser():
    """Build a minimal replica of the syriana top-level parser."""
