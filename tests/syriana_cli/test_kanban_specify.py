"""Tests for the specifier module + `syriana kanban specify` CLI surface.
...
from syriana_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `syriana kanban …` argparse surface directly."""
