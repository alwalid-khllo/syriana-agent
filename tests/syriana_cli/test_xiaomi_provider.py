...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from syriana_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in SYRIANA_OVERLAYS
        overlay = SYRIANA_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify syriana doctor recognizes Xiaomi env vars."""
