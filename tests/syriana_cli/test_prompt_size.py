"""Tests for the ``syriana prompt-size`` diagnostic (issue #34667)."""

import json

import pytest

from syriana_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(syriana_home, memory_text="", user_text=""):
    mem_dir = syriana_home / "memories"
...
def _seed_skill(syriana_home, name, description):
    skill_dir = syriana_home / "skills" / "demo" / name
