...
The notice prints the most recent curator run summary on `syriana update`,
...
session start) so users normally never see the rename map. `syriana update`
