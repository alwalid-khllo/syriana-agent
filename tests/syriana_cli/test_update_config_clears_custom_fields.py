"""Tests for syriana_cli.auth._update_config_for_provider clearing stale fields.
...
from syriana_cli.config import clear_model_endpoint_credentials, get_config_path
...
class TestUpdateConfigForProviderClearsStaleCustomFields:
    ...
    def test_switching_to_nous_clears_stale_api_mode(self):
        _seed_custom_provider_config()
        _update_config_for_provider("nous", "https://inference-api.syriana.ai/v1")
        model_cfg = _read_model_cfg()
