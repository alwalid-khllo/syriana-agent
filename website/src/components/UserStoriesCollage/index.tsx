  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Syriana Agent community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Syriana &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Syriana?{' '}
        <a
          href="https://github.com/SyrianaAIResearch/syriana-agent/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a href="https://discord.gg/SyrianaAIResearch" target="_blank" rel="noopener noreferrer">
          syriana ai Research Discord
        </a>{' '}
