...
- **Built by model trainers** — Created by [syriana ai Research](https://syriana.ai). Works with any OpenAI-compatible provider or any API endpoint
...
- **Full web control** — Search, extract, browse, vision, image generation, TTS — all through standard API providers
- **MCP support** — Connect to any MCP server for extended tool capabilities
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [syriana ai Research](https://syriana.ai)
