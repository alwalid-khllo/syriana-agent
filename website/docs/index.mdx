...
slug: /
sidebar_position: 0
title: "Syriana Agent Documentation"
description: "The self-improving AI agent with a built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
The self-improving AI agent built by [syriana ai Research](https://syriana.ai). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
>
  ...
  <a
    href="https://syriana-agent.fixology.dev/"
    style={{
      display: "inline-block",
      padding: "0.6rem 1.2rem",
  ...
  <a
    href="https://github.com/alwalid-khllo/syriana-agent"
    style={{
      display: "inline-block",
      padding: "0.6rem 1.2rem",
      border: "1px solid rgba(255,215,0,0.2)",
...
To easily install the command-line and desktop applications, [download the Syriana Desktop installer](https://syriana-agent.fixology.dev/) from our website and run it.
...
After installing, run `syriana setup` — set your API key, configure providers, and start chatting right away.
:::
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend Syriana safely  |
| 🧭 **[Use MCP with Syriana](/guides/use-mcp-with-syriana)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Syriana](/guides/use-voice-mode-with-syriana)** | Hands-on setup and usage patterns for Syriana voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define Syriana' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of Syriana                              |
...
- **Built by model trainers** — Created by [Nous Research](https://syriana.ai), the lab behind Syriana, Nomos, and Psyche. Works with [Nous Portal](https://portal.syriana.ai), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Nous Research](https://syriana.ai) — the lab behind Syriana, Nomos, and Psyche models
