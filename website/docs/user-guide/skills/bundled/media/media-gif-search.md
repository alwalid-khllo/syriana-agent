...
Set your Tenor API key in your environment (add to `${SYRIANA_HOME:-~/.syriana}/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/SyrianaAIResearch/syriana-agent/blob/main/skills/media/gif-search/url)`
