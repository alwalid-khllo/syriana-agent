...
| Related skills | [`claude-code`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-claude-code), [`syriana-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-syriana-agent) |
...
Delegate coding tasks to [Codex](https://github.com/openai/codex) via the Syriana terminal. Codex is OpenAI's autonomous coding agent CLI.
...
For Syriana itself, `model.provider: openai-codex` uses Syriana-managed Codex
OAuth from `~/.syriana/auth.json` after `syriana auth add openai-codex`. For the
...
## Syriana Gateway Caveat

When invoking the Codex CLI from a Syriana gateway/service context (for example,
