...
| | |
|---|---|
| Source | Optional — install with `syriana skills install official/blockchain/solana` |
| Path | `optional-skills/blockchain/solana` |
| Version | `0.2.0` |
| Author | Deniz Alagoz (gizdusum), enhanced by Syriana Agent |
| License | MIT |
...
Helper script path: ~/.syriana/skills/blockchain/solana/scripts/solana_client.py
