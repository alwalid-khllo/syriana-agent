...
| | |
|---|---|
| Source | Optional — install with `syriana skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.syriana/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.syriana/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Syriana installs package this)
