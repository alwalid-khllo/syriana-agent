...
| | |
|---|---|
| Source | Optional — install with `syriana skills install official/productivity/canvas` |
...
4. Name the token (e.g., "Syriana Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `${SYRIANA_HOME:-~/.syriana}/.env`:
