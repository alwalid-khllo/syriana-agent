...
| | |
|---|---|
| Source | Optional — install with `syriana skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Syriana Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $SYRIANA_OSINT_CACHE/icij/ (default: ~/.cache/syriana-osint/icij/).
...
# Set SYRIANA_OSINT_UA=your-app/1.0 (your@email) to identify yourself
