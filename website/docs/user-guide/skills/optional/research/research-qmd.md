...
| | |
|---|---|
| Source | Optional — install with `syriana skills install official/research/qmd` |
...
Syriana Agent via the native MCP client. This is the preferred
...
Then configure Syriana Agent to connect via HTTP:
