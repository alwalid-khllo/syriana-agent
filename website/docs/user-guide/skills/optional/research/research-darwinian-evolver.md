...
| | |
|---|---|
| Source | Optional — install with `syriana skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research/darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), Syriana Agent |
| License | MIT |
...
import upstream classes into Syriana itself.
...
Open `~/.syriana/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Syriana core.
   Custom driver scripts under `~/.syriana/skills/...` are user-side and fine.
