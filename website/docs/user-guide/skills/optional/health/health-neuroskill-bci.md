...
| | |
|---|---|
| Source | Optional — install with `syriana skills install official/health/neuroskill-bci` |
...
Connect Syriana to a running [NeuroSkill](https://neuroskill.com/) instance to read
