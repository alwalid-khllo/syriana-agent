...
- User wants **Syriana itself to drive a browser** → use Syriana' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
