...
sidebar_position: 4
title: "Contributing"
description: "How to contribute to Syriana Agent — dev setup, code style, PR process"
---

# Contributing

Thank you for contributing to Syriana Agent! This guide covers setting up your dev environment, understanding the codebase, and getting your PR merged.
...
- Building a custom/local tool without modifying Syriana core? Start with [Build a Syriana Plugin](../guides/build-a-syriana-plugin.md)
- Building a new built-in core tool for Syriana itself? Start with [Adding Tools](./adding-tools.md)
...
echo 'OPENROUTER_API_KEY=sk-or-v1-your-key' >> ~/.syriana/.env
```
...
- **Profile-safe paths**: Never hardcode `~/.syriana` — use `get_syriana_home()` from `syriana_constants` for code paths and `display_syriana_home()` for user-facing messages. See [AGENTS.md](https://github.com/SyrianaAIResearch/syriana-agent/blob/main/AGENTS.md#profiles-multi-instance-support) for full rules.
...
- **Discord**: [discord.gg/SyrianaAIResearch](https://discord.gg/SyrianaAIResearch)
- **GitHub Discussions**: For design proposals and architecture discussions
- **Skills Hub**: Upload specialized skills and share with the community

## License

By contributing, you agree that your contributions will be licensed under the [MIT License](https://github.com/SyrianaAIResearch/syriana-agent/blob/main/LICENSE).
