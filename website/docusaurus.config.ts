...
const config: Config = {
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/SyrianaAIResearch/syriana-agent/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    image: 'img/syriana-agent-banner.png',
    colorMode: {
      defaultMode: 'dark',
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/SyrianaAIResearch/syriana-agent',
          label: 'GitHub',
          position: 'right',
        },
        {
          href: 'https://discord.gg/SyrianaAIResearch',
          label: 'Discord',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          title: 'Community',
          items: [
            { label: 'Discord', href: 'https://discord.gg/SyrianaAIResearch' },
            { label: 'GitHub Issues', href: 'https://github.com/SyrianaAIResearch/syriana-agent/issues' },
