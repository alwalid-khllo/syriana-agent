...
```bash
python3 -m pyfiglet "SYRIANA" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=SYRIANA&font=Slant" | boxes -d stone
```
