...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^Syriana\s+(Agent|Audit)$", re.IGNORECASE),
...
IGNORED_EMAILS = {
    ...
    "syriana@nousresearch.com",
    "syriana-audit@example.com",
    "syriana@habibilabs.dev",
    "omx@oh-my-codex.dev",
    "codex@openai.com",
...
def gh_pr_list():
    ...
    try:
        result = subprocess.run(
            [
                "gh", "pr", "list",
                "--repo", "SyrianaAIResearch/syriana-agent",
                "--state", "merged",
