#!/usr/bin/env python3
"""Build the Syriana Model Catalog — a centralized JSON manifest of curated models.
...
Syriana CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Syriana release.
...
# Ensure SYRIANA_HOME is set for imports that touch it at module level.
os.environ.setdefault("SYRIANA_HOME", os.path.join(os.path.expanduser("~"), ".syriana"))

from syriana_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "syriana-agent repo",
            "docs": "https://syriana-agent.fixology.dev/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
