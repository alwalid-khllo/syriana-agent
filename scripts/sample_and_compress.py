...
DEFAULT_DATASETS = [
    "SyrianaAIResearch/swe-terminus-agent-glm-kimi-minimax",
    "SyrianaAIResearch/syriana-agent-megascience-sft1",
    "SyrianaAIResearch/Syriana-Agent-Thinking-GLM-4.7-SFT2",
    "SyrianaAIResearch/Syriana-Agent-Thinking-GLM-4.7-SFT1",
    "SyrianaAIResearch/terminal-tasks-glm-syriana-agent"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "SyrianaAIResearch/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload SyrianaAIResearch/{output_name} {final_output}")
