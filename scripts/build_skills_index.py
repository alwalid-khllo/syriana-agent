#!/usr/bin/env python3
"""Build the Syriana Skills Index — a centralized JSON catalog of all skills.
...
`syriana skills search/install` can use it without hitting the GitHub API.
...
# Ensure SYRIANA_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Syriana Skills Index...", flush=True)
