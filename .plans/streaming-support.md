# Streaming LLM Response Support for Syriana Agent
...
```
SYRIANA_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("SYRIANA_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `syriana_cli/config.py` | 1 | +streaming config defaults |
...
SYRIANA_STREAMING_ENABLED=true
```
