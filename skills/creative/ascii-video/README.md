...
Built for [Syriana Agent](https://github.com/SyrianaAIResearch/syriana-agent). Usable in any coding agent. Canonical source lives here; synced to [`SyrianaAIResearch/syriana-agent/skills/creative/ascii-video`](https://github.com/SyrianaAIResearch/syriana-agent/tree/main/skills/creative/ascii-video) via PR.
