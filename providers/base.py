...
def _profile_user_agent() -> str:
    """Return a ``syriana-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from syriana_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"syriana-cli/{_ver}"
    except Exception:
        return "syriana-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # syriana-cli UA so the catalog endpoint is reachable.
