...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around Syriana's web-provider config and
        ...
        # native search engine for xAI sessions instead of Syriana's
        # configured web provider (Tavily/etc.), and those results bypass
        # Syriana's tool-trace / citation plumbing (they arrive baked into the
