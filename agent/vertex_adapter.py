"""Vertex AI (Google Cloud) adapter for Syriana Agent.

Provides authentication and configuration for Vertex AI's OpenAI-compatible
endpoint. This allows Syriana to use Gemini models via Google Cloud with
...
# who installed plain `syriana-agent` and only later selected a Gemini model.
try:
