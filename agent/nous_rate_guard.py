...
(3 SDK retries x 3 Syriana retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = get_syriana_home()
    except ImportError:
        base = os.path.join(os.path.expanduser("~"), ".syriana")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, Syriana, ...) behind one endpoint.  A 429 can mean either:
