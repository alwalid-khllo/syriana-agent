...
export interface Translations {
  ...
  status: {
    ...
    stopped: string;
    updateSyriana: string;
    updateSyrianaConfirmMessage?: string;
    updateSyrianaConfirmNow?: string;
    updateSyrianaConfirmTitle?: string;
    updatingSyriana: string;
  ...
  // ── Achievements plugin (plugins/syriana-achievements) ──
  achievements: {
    hero: {
      kicker: string;
      title: string;
