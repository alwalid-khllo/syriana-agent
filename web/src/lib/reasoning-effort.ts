 ...
 *
 * Values mirror syriana_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Syriana default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Syriana' default when unset). */
