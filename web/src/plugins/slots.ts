 ...
 * `window.__SYRIANA_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Syriana brand in the top bar
 ...
 *  `window.__SYRIANA_PLUGINS__.registerSlot(...)`.
 *
