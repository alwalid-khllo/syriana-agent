/**
 * Syriana Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__SYRIANA_PLUGIN_SDK__`` and
 * ``window.__SYRIANA_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__SYRIANA_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``SyrianaPluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@syriana/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__SYRIANA_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__SYRIANA_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__SYRIANA_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface SyrianaPluginSDK {
...
declare global {
  interface Window {
    __SYRIANA_PLUGIN_SDK__?: SyrianaPluginSDK;
    __SYRIANA_PLUGINS__?: PluginRegistry;
  }
}
