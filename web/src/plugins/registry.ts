 ...
 *
 * Plugins call window.__SYRIANA_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__SYRIANA_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__SYRIANA_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__SYRIANA_PLUGIN_SDK__ = {
    ...
    // window.__SYRIANA_SESSION_TOKEN__ directly.
    authedFetch,
