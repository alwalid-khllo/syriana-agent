...
const STORAGE_KEY = "syriana-dashboard-theme";
...
const FONT_STORAGE_KEY = "syriana-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `syriana_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "syriana-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-syriana-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-syriana-theme-font", "true");
