 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `syriana_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Syriana Teal",
  description: "Classic dark teal — the canonical Syriana look",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Syriana Teal (Large)",
  description: "Syriana Teal with bigger fonts and roomier spacing",
