...
Invoked by ``syriana kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Syriana Agent board.
...
def _profile_author() -> str:
    """Mirror of ``syriana_cli.kanban._profile_author``."""
    return (
