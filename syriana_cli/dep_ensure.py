...
def _has_syriana_agent_browser() -> bool:
    ...
    # install.sh installs globally into $SYRIANA_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-SyrianaHome", str(get_syriana_home()),
        ]
    else:
        cmd = ["bash", str(script), "--ensure", dep]

    run_env = syriana_subprocess_env(inherit_credentials=False)
