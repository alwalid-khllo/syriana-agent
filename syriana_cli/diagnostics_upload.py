"""Client for uploading ``syriana debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``syriana debug share``.
...
NAS_BASE = os.environ.get(
    "SYRIANA_DIAGNOSTICS_BASE_URL", "https://portal.fixology.dev"
)
...
_USER_AGENT = "syriana-agent/debug-share"
