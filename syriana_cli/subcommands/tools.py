"""``syriana tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'syriana tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # syriana tools list [--platform cli]
    ...
    # syriana tools disable <name...> [--platform cli]
    ...
    # syriana tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `syriana tools` runs after you pick a provider that\n"
