...
Entry point: ``syriana whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``syriana_cli/main.py``).
...
Syriana gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Syriana to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Syriana needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Syriana gateway in another terminal:")
    print("         syriana gateway")
    print()
    ...
    print()
    print("  Docs: https://syriana-agent.fixology.dev/docs/user-guide/")
