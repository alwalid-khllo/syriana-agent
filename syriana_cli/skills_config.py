"""
Skills configuration for Syriana Agent.
`syriana skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.syriana/config.yaml under:
...
from syriana_cli.config import cfg_get, load_config, save_config
from syriana_cli.colors import Colors, color
from syriana_cli.platforms import PLATFORMS as _PLATFORMS
...
def skills_command(args=None):
    """Entry point for `syriana skills`."""
    from syriana_cli.curses_ui import curses_checklist
