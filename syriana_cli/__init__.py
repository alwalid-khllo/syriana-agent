"""
Syriana CLI - Unified command-line interface for Syriana Agent.

Provides subcommands for:
- syriana chat          - Interactive chat (same as ./syriana)
- syriana gateway       - Run gateway in foreground
- syriana gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `syriana setup` on a fresh Pi.
    ...
    syriana_cli/stdio.py::configure_windows_stdio() runs later from the entry
