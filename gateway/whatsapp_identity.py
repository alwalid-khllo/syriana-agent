...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$SYRIANA_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_syriana_dir("platforms/whatsapp/session", "whatsapp/session")
