...
Hooks are discovered from ~/.syriana/hooks/ directories, each containing:
...
HOOKS_DIR = get_syriana_home() / "hooks"
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"syriana_hook_{hook_name}"
