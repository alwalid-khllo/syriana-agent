...
try:
    ...
    _SYRIANA_VERSION = "0.0.0"

_APP_VERSION = _SYRIANA_VERSION
_BOT_VERSION = _SYRIANA_VERSION
_YUANBAO_INSTANCE_ID = str(SYRIANA_INSTANCE_ID)  # single source: yuanbao_proto.SYRIANA_INSTANCE_ID
