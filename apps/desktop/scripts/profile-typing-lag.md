...
cd apps/desktop
XCURSOR_SIZE=24 SYRIANA_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/syriana-typing
# → /tmp/syriana-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/syriana-typing.before.heapsnapshot
# → /tmp/syriana-typing.after.heapsnapshot
```
