...
export interface PetInfo {
  ...
  // the Syriana "run" activity state uses the in-place running row).
 ...
 * SYRIANA_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'syriana.desktop.pet-roam.v1'
