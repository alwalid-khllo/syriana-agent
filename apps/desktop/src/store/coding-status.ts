...
import type { SyrianaGitWorktree, SyrianaRepoStatus } from '@/global'
...
export const $repoStatus = atom<SyrianaRepoStatus | null>(null)
...
export const $repoWorktrees = atom<SyrianaGitWorktree[]>([])
