...
const desktopWindow = window as unknown as { syrianaDesktop?: Window['syrianaDesktop'] }
const initialSyrianaDesktop = desktopWindow.syrianaDesktop

function installDesktopBridge(partial: Partial<Window['syrianaDesktop']> = {}) {
  desktopWindow.syrianaDesktop = {
    fetchLinkTitle: vi.fn().mockResolvedValue(''),
    openExternal: vi.fn().mockResolvedValue(undefined),
    ...partial
  } as unknown as Window['syrianaDesktop']
}
...
afterEach(() => {
  ...
  if (initialSyrianaDesktop) {
    desktopWindow.syrianaDesktop = initialSyrianaDesktop
  } else {
    delete desktopWindow.syrianaDesktop
  }
})
...
describe('external link helpers', () => {
  ...
  it('deduplicates in-flight title fetches and caches results', async () => {
    ...
    installDesktopBridge({ fetchLinkTitle: bridge as unknown as Window['syrianaDesktop']['fetchLinkTitle'] })
  ...
  it('opens links via the desktop bridge', () => {
    ...
    installDesktopBridge({ openExternal: openExternal as unknown as Window['syrianaDesktop']['openExternal'] })
