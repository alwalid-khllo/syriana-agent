...
import type { StarmapEdge, StarmapGraph, StarmapNode } from '@/types/syriana'
...
const VERSION = 3
const PREFIX = 'HML' // "Syriana Memory Loadout" — namespaces our codes like WoW's leading bytes.
