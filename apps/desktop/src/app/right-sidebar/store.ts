...
const TAKEOVER_KEY = 'syriana.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Syriana can't clear via the API — the user
 *  sees exactly what runs instead of Syriana silently deleting their creds. */
