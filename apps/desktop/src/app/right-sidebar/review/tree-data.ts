import type { SyrianaReviewFile } from '@/global'
...
export function buildReviewFlatList(files: SyrianaReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: SyrianaReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
