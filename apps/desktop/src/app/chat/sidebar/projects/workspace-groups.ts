...
import type { ProjectInfo, SessionInfo } from '@/syriana'
 ...
 * repo shows its branches/worktrees even when they have no Syriana sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: SyrianaGitWorktree[]
): SidebarSessionGroup[] {
