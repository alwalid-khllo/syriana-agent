...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/syriana'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('syriana:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('syriana:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask Syriana to
