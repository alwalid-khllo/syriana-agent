...
const FOCUS_EVENT = 'syriana:composer-focus'
const INSERT_EVENT = 'syriana:composer-insert'
const INSERT_REFS_EVENT = 'syriana:composer-insert-refs'
const SUBMIT_EVENT = 'syriana:composer-submit'
const VOICE_TOGGLE_EVENT = 'syriana:composer-voice-toggle'
