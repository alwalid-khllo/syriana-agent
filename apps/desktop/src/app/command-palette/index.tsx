...
import { getSyrianaConfigRecord, listAllProfileSessions } from '@/syriana'
...
// Syriana session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
...
export function CommandPalette() {
  ...
  const configQuery = useQuery({
    ...
    queryFn: getSyrianaConfigRecord,
    enabled: open
  })
    ...
    return [
      ...
      ...branchGroup,
      {
        ...
        items: [
          ...
          {
            icon: Download,
            id: 'cc-update-syriana',
            keywords: ['update', 'upgrade', 'syriana', 'version', 'system', 'restart'],
            label: cc.updateSyriana,
