...
import { deleteSession, listAllProfileSessions, setSessionArchived } from '@/syriana'
...
// / Program Files), which buried any files Syriana wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.syrianaDesktop` is
    ...
    const settings = window.syrianaDesktop?.settings
