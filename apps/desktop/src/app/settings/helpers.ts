...
import type { SyrianaConfigRecord, ToolsetInfo } from '@/types/syriana'
...
export function getNested(obj: SyrianaConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: SyrianaConfigRecord, path: string, value: unknown): SyrianaConfigRecord {
...
function personalityOptions(config: SyrianaConfigRecord): string[] {
