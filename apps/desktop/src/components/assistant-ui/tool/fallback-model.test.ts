  ...
  it('shows failed title when navigate returns success=false', () => {
    const view = buildToolView(
      part({
        ...
        args: { url: 'https://syriana-agent.syriana.ai/docs' },
    ...
    expect(view.title).toBe('Failed to open syriana-agent.syriana.ai')
  })
  ...
  it('shows opened title on success', () => {
    const view = buildToolView(
      part({
        toolName: 'browser_navigate',
        args: { url: 'https://syriana-agent.syriana.ai/docs' },
        result: { success: true, url: 'https://syriana-agent.syriana.ai/docs', title: 'Docs' }
      }),
      ''
    )

    expect(view.status).toBe('success')
    expect(view.title).toBe('Opened syriana-agent.syriana.ai')
  })
})
