...
export const en: Translations = {
  ...
  boot: {
    ready: 'Syriana Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Syriana settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingSyrianaDesktop: 'Starting Syriana Desktop…'
    },
    errors: {
      backgroundExited: 'Syriana background process exited.',
      backgroundExitedDuringStartup: 'Syriana background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Syriana backend is older than this desktop build and may not work correctly. Update to align them.',
    updateSyriana: 'Update Syriana',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Syriana Desktop.',
    ...
    native: {
      ...
      inputBody: 'Syriana is waiting for your response.',
      turnDoneTitle: 'Syriana finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Syriana defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Syriana is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Syriana asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Syriana was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Syriana follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Syriana is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Syriana, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Syriana checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Syriana configuration...',
    ...
    gateway: {
      ...
      intro:
        'Syriana Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Syriana backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      envOverrideDesc:
        'Unset SYRIANA_DESKTOP_REMOTE_URL and SYRIANA_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Syriana backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote Syriana backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      remoteUrlTitle: 'Remote URL',
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /syriana.',
      ...
      restartingMessage: 'Syriana Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Syriana ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Syriana runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via syriana curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As Syriana builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Syriana to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Syriana to generate pets.',
      backgroundHint: 'You can close this — Syriana will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Syriana desktop' },
    ...
    syrianaActiveSessions: (version, count) => `Syriana ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@syriana:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Syriana environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Syriana will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Syriana backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Syriana. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Syriana...',
    placeholderReconnecting: 'Reconnecting to Syriana…',
    ...
    attachUrlDesc: 'Syriana will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Syriana to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Syriana…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Syriana…',
    ...
    unsupportedMessage: 'This version of Syriana can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Syriana from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Syriana will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Syriana desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Syriana updater takes over in its own window and reopens Syriana automatically when it’s done. Please don’t reopen Syriana yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Syriana reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Syriana reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Syriana needs a one-time install',
    ...
    settingUpTitle: 'Setting up Syriana Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Syriana CLI or desktop instance is running. Stop any running Syriana instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Syriana Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Syriana is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Syriana…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Syriana',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Syriana at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Syriana connects automatically',
    ...
    authorizeThere: 'Authorize Syriana there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Syriana there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Syriana Desktop v${version}`,
      ...
      gatewayTitle: 'Syriana inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Syriana will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Syriana is restarting...',
      askRestart: 'Ask Syriana to restart the server',
      lookingRestart: taskId => `Syriana is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Syriana is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Syriana finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Syriana could not restart the server.',
      stillWorking:
        'Syriana is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Syriana is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Syriana gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.syriana/config.yaml). Syriana won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Syriana needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Syriana needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Syriana Desktop to use Save Image.',
    restartToSaveImages: 'Restart Syriana Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `syriana gateway` running?'
    }
  },
