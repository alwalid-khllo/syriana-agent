...
Data file: $SYRIANA_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_SYRIANA_HOME = Path(os.environ.get("SYRIANA_HOME", Path.home() / ".syriana"))
DATA_DIR = _SYRIANA_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
