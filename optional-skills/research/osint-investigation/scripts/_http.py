...
DEFAULT_UA = (
    "syriana-osint-investigation/0.2 "
    "(+https://github.com/SyrianaAIResearch/syriana-agent; "
    "set SYRIANA_OSINT_UA env var to identify yourself per "
...
def get(
    ...
    *,
    ...
    h = {"User-Agent": user_agent or os.environ.get("SYRIANA_OSINT_UA", DEFAULT_UA)}
    if headers:
        h.update(headers)
