...
{ ... }:
{
  perSystem =
    ...
    let
      ...
      syrianaNpmLib = self'.packages.default.passthru.syrianaNpmLib;
      ...
      # Non-npm packages may have their own devShellHook (e.g. syriana-agent
    ...
    in
    {
      devShells.default = pkgs.mkShell {
        ...
        shellHook = ''
          echo "Syriana Agent dev shell"
          ${combinedNonNpm}
          ${syrianaNpmLib.mkNpmDevShellHook npmPackageJsonPaths}
          echo "Ready. Run 'syriana' to start."
        '';
      };
    };
}
