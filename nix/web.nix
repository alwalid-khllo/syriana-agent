# nix/web.nix — Syriana Web Dashboard (Vite/React) frontend build
{ pkgs, syrianaNpmLib, ... }:
let
  npm = syrianaNpmLib.mkNpmPassthru { folder = "web"; attr = "web"; pname = "syriana-web"; };
...
pkgs.buildNpmPackage (npm // {
  ...
  buildPhase = ''
    ...
    # outDir in vite.config.ts points to ../syriana_cli/web_dist for the
