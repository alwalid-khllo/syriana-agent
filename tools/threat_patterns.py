...
_PATTERNS: List[Tuple[str, str, str]] = [
    ...
    (r'unset\s+\w*(?:CLAUDE|CODEX|SYRIANA|AGENT|OPENAI|ANTHROPIC)\w*', "env_var_unset_agent", "context"),
    ...
    (r'\$HOME/\.syriana/\.env|\~/\.syriana/\.env', "syriana_env", "strict"),
    ...
    (r'(update|modify|edit|write|change|append|add\s+to)\s+[^\n]{0,2048}\.syriana/(config\.yaml|SOUL\.md)', "syriana_config_mod", "strict"),
...
def scan_for_threats(content: str, scope: str = "context") -> List[str]:
    ...
    # bypassing keyword checks (e.g. ``ｃａｔ ~/.syriana/.env``).  NOTE: this
