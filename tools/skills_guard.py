...
Trust levels:
  - builtin:   Ships with Syriana. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.syriana/\.env|\~/\.syriana/\.env',
     "syriana_env_access", "critical", "exfiltration",
     "directly references Syriana secrets file"),
    ...
    (r'\.syriana/config\.yaml|\.syriana/SOUL\.md',
     "syriana_config_mod", "critical", "persistence",
     "references Syriana configuration files directly"),
...
# scan. `.skillignore` is the Syriana-native name; `.clawhubignore` is honored
