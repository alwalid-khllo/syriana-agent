...
_DEFAULT_TOOL_GATEWAY_DOMAIN = "fixology.dev"
...
def auth_json_path():
    """Return the Syriana auth store path, respecting SYRIANA_HOME overrides."""
    return get_syriana_home() / "auth.json"
...
def peek_nous_access_token() -> Optional[str]:
    ...
    Availability scans (`syriana tools`, banner/status paint, provider
