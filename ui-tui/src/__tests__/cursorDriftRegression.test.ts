 ...
 *
 * Symptom: in `syriana --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@syriana/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using syriana --tui and as i type multiline my caret at the end will often ' +
