...
import type { ScrollBoxHandle } from '@syriana/ink'
import { evictInkCaches } from '@syriana/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.SYRIANA_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
