import { Box, type ScrollBoxHandle, stringWidth, Text } from '@syriana/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (SYRIANA_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (SYRIANA_DEV_CREDITS), lowest priority,
