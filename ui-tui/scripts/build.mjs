...
await build({
  ...
  // Skip the prebuilt @syriana/ink bundle and inline the source instead:
  ...
  alias: { '@syriana/ink': resolve(root, 'packages/syriana-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The syriana_cli launcher
