#!/usr/bin/env python3
"""
SWE Runner with Syriana Trajectory Format

A runner that uses Syriana-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Syriana-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Syriana-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Syriana format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Syriana-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Syriana-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Syriana Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Syriana-Agent's built-in execution environments
    and outputs trajectories in Syriana-Agent format.
    """
    ...
    def _convert_to_syriana_format(
        self,
        ...
        """
        Convert internal message format to Syriana trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Syriana trajectory format
        trajectory = self._convert_to_syriana_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Syriana trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Syriana Trajectory Format")
    print("=" * 60)
