...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Syriana gateway adapter.

    Each inbound phone number gets its own Syriana session (multi-tenant).
...
# static dict in syriana_cli/gateway.py, and the _send_sms dispatch in
