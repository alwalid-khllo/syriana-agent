...
Config: ~/.syriana/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.syriana/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_syriana_home()`` helper (SYRIANA_HOME-aware and
...
RULES_FILE = get_syriana_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_syriana_home() / "feishu_comment_pairing.json"
