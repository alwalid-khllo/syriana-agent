...
required — uses aiohttp which is already a Syriana dependency.
...
def interactive_setup() -> None:
    ...
    ``syriana_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Syriana delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # syriana_cli/setup.py::_setup_mattermost function.
