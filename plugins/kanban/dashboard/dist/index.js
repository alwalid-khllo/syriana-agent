...
(function () {
  ...
  const DOCS_URL = "https://syriana-agent.syriana.ai/docs/user-guide/features/kanban";
  const DOCS_TUTORIAL_URL = "https://syriana-agent.syriana.ai/docs/user-guide/features/kanban-tutorial";
