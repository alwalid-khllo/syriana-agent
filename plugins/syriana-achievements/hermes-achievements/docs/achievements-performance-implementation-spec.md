# Syriana Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.syriana/plugins/syriana-achievements/state.json` (existing unlock state)
  - `~/.syriana/plugins/syriana-achievements/scan_snapshot.json` (new)
  - `~/.syriana/plugins/syriana-achievements/scan_checkpoint.json` (new)
