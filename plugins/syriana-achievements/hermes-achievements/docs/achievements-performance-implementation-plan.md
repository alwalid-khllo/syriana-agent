# Syriana Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.syriana/plugins/syriana-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.syriana/plugins/syriana-achievements/scan_checkpoint.json`.
