...
``_check_spotify_available()`` — when the user has not run ``syriana auth
spotify``, the tools remain registered (so they appear in ``syriana
...
The Spotify auth flow (``syriana auth spotify``), CLI plumbing, and docs
